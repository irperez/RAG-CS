...
| **`IEmbeddingGenerator` / `OllamaEmbeddingGenerator`** | **Vectorization** | Communicates with the local `locusai/all-minilm-l6-v2` endpoint on Ollama to convert text chunks into high-dimensional vectors. | `HttpClient` |
